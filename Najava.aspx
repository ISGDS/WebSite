<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Najava.aspx.cs" Inherits="_Default" %>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li class="active"><a href="Najava.aspx">Najava<span class="sr-only">(current)</span></a></li>
        ...
        <div class="row">
            <div class="col-lg-offset-3 col-lg-2">
                <asp:Label ID="Label3" runat="server" Text="Potvrdi lozinka:"></asp:Label>
            </div>
            <div class="col-lg-2">
                <asp:TextBox ID="Lozinka1" runat="server"></asp:TextBox>
                </div>
            <div class="col-lg-2">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="Lozinka1" ErrorMessage="Potvrdete ja lozinkata" ForeColor="#CC0000"></asp:RequiredFieldValidator>
                </div>
        
        </div>
            <div class="row">
                <div class="col-lg-offset-5 col-lg-3">
                    <asp:Button ID="btnLogin_Click" runat="server" OnClick="btnLogin_Click_Click" Text="Najavi se" />
                    </div>
                <div class="col-lg-3">
                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="Lozinka" ControlToValidate="Lozinka1" ErrorMessage="Lozinkite ne se isti" ForeColor="#CC0000"></asp:CompareValidator>
                </div>
            </div>
